...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { custom_reward_id: @reward.custom_reward_id, name: @reward.name } }, as: :json
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { custom_reward_id: @reward.custom_reward_id, name: @reward.name } }, as: :json
    assert_response :success
  end
